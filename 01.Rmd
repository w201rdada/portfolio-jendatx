...
## Why are we still Chained to our Keyboards?
...
Instead, it's time we design a wearable solution that leverages our time-tested typing skills - already standardized via QWERTY and Dvorak keyboards.  With the [miniature accelerometers](https://thepihut.com/products/triple-axis-accelerometer-bma220-tiny)that can translate motion into device input now at hobbyist pricepoints, we can loose the chains tying good typists to our keyboards. There's really no good reason why we can't compose our prose on any surface - literally - at hand.   
