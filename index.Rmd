...
library(magrittr)
readLines('https://www.zotero.org/api/users/4668935/collections/7KHPHW7F/items/top?limit=1&format=bibtex&key=qjxa6FVWROcANpn1pWRo6aQz&v=1') %>% writeLines('references.bib')
