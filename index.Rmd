...
readLines('https://www.zotero.org/api/users/4668935/collections/7KHPHW7F/items/top?start=0&limit=null&format=bibtex&itemKey=GQF4QWHF&key=qjxa6FVWROcANpn1pWRo6aQz&v=1') %>% writeLines('references.bib')
